...
Typically, the trajectory of the center of mass is recovered from the joint trajectories by the projection. 
...
generated by \emph{Grab} task alone. \emph{Grab} task is then first selected in \emph{motion 3.a}.
