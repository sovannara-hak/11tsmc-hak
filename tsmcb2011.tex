...
In that case differential link between the error and the robot configuration 
is the Jacobian $\mbf{J} = \dpartial{\mbf{p}}{\mbf{q}}$.
...
That last assumption discards sequential movements and all inequalities constraints because
