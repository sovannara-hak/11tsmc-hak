...
by the robot.
It has to be noted that our approach relies also on some strong assumptions. The difference is that those
assumptions are directly related to the robot control framework.
