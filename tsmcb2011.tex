...
As a consequence, uncertainties in the kinematic model will negatively affect the performance of the method.
...
handle numerical noise due to successive projections.
...
\emph{motion 2.a} and \emph{motion 2.b} with a termination threshold set to $ \epsilon = 0.07$.
\begin{table}[t]
  \centering
  \begin{tabular}{|c|c|c|c|}
    \hline
