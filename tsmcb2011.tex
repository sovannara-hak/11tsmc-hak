...
possibly-used tasks is known. The kinematic model of the robot and all the tasks that may appear in a
motion are known.
...
The considered approach handles tasks executed in parallel because
