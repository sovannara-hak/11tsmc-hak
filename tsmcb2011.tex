...
% The paper headers
\markboth{Submitted to IEEE Transaction on Systems, Man, and Cybernetics}{}%
% make the title area
\maketitle
...
\begin{figure*}[t]
  ...
  structuring the action (from~\cite{yoshida07}).]{
  \makebox[\linewidth]{
  \begin{tabular}{c@{}c@{}c@{}c@{}c@{}}
    \includegraphics[height=1.9cm]{img/purpleBall1.ps}&
    \includegraphics[height=1.9cm]{img/purpleBall2.ps}&
    \includegraphics[height=1.9cm]{img/purpleBall3.ps}&
    \includegraphics[height=1.9cm]{img/purpleBall4.ps}&
    \includegraphics[height=1.9cm]{img/purpleBall5.ps}\\
  \end{tabular}
  ...
  module. It is an integral part of the embodied action \emph{grasping} (from~\cite{kanoun10}).]{
  \makebox[\linewidth]{
  \begin{tabular}{c@{}c@{}}
    \includegraphics[height=1.9cm]{img/graspFeet1.ps}&
    \includegraphics[height=1.9cm]{img/graspFeet2.ps}\\
  \end{tabular}
  \label{fig:introExample:graspFeet}
  }
  }
  \subfigure[To grasp the ball in front of it (left), the robot
  reaches a posture where the left arm is used to maintain its balance. In
  the figure on the right, the robot performs two actions in parallel:
  ...
  \makebox[\linewidth]{
  \includegraphics[height=2.0cm]{img/spotDiff1H.ps}
  }
...
performed by the humanoid robot HRP-2 at LAAS-CNRS as shown in Fig.~\ref{fig:introExample:purpleBall}. 
...
are respected, the method is theoritically valid for other robots.
...
However, informations from the environment are generally used and
...
model. In the remainder of this paper, we will consider that
...
The question is now how to extract informations of higher levels from supposedly-known human
...
While all the approaches presented above can only recognize non-parallel task and rely on heuristics,
...
%In that case differential link between the error and the robot configuration is 
...
they come with the parameters $\lambda$ that characterize their decrease speed. 
...
It is assumed that the behavior model $\mbf{\dot{e}^*}$ of every
possibly-used tasks is known. The kinematic model of the robot and all tasks that may appear in a 
motion are known. 
...
The tasks that may appear in a motion have to be known because the considered approach
of the recognition is to consider the recognition problem 
as a selection in a finite set problem.
The set of possible tasks is called the \emph{task pool}.
Possible tasks may for example be end-effector, center of mass, visual or posture servoing.
The approach considered handles tasks executed in parallel because
it allows a good expressivity of movements thanks to the different
possible tasks combination.
The observed motion is supposed to have been generated using an unknown sub-set of the task pool.
...
That last assumption discards sequential movements and all inequalities and conditional constraints because
such constraints involves a change in the stack of tasks used to generate the movement.
It also discards non consistent motions which appear when not trying to 
avoid singularities.
Another consequence of that assumption is that the hierarchy of the tasks are not considered
since all tasks are assumed to be completely fulfilled.
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.7\linewidth]{img/spotDiff.ps}
  \end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\linewidth]{img/final3.ps}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\linewidth]{img/spotDiff3.ps}
\end{center}
...
\begin{table}[h]
  \centering
    ...
    \hline
  \end{tabular}
  \caption{The table of considered motions and tasks.}
  \label{tab:motion}
\end{table}
...
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot0_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot0_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot0_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot0_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot0_499.png.ps}}\\

(b)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_0.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot1_499.png.ps}}\\

(c)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_0.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot2_499.png.ps}}\\

(d)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_0.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot3_499.png.ps}}\\

(e)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_0.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot4_499.png.ps}}\\

(f)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_0.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_99.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_199.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_299.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_399.png.ps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/Pqdot5_499.png.ps}}\\
\\
...
\label{fig:XP2RFit}
\end{figure*}
The residue of the optimization for \emph{Left Hand} is higher than 
the residue for \emph{Right Hand}. At this step, the movements
analyzed is better explained by \emph{Right Hand} than by \emph{Left Hand}. 
...
\hline
\end{tabular}
\caption{Results of the task selection algorithm from the analysis of \emph{motion 2.a} and \emph{motion 2.b}.}
\label{tab:spotDiff1}
\vspace{-20pt}
\end{table}
...
that is empirically fixed to $\epsilon = 0.07$ in order to
handle numerical noise due to successive projections (the threshold depends
    on the number of tasks involved in the movement).
...
\begin{table}[t]
  ...
  \emph{motion 3.a} and \emph{motion 3.b}.}
  \label{tab:spotDiff2}
  \vspace{-3pt}
\end{table}
As in the previous experiments, the task \emph{Screw} can not be properly fitted on the trajectory
generated on \emph{motion~3.a}. 
In \emph{motion 3.b}, both tasks \emph{Grab} and \emph{Screw} are detected, whereas 
the task \emph{Screw} is not selected in \emph{motion~3.a}. The selection of both tasks
in \emph{motion 3.b} is explained by the fact that \emph{Grab} is actually a sub-task of \emph{Screw}.
...
%During the analysis of \emph{motion 3.b}, the \emph{grabbing} task
...
%in the analysis of \emph{motion 3.a}.

\subsubsection{Screw VS Gaze}
\label{sec:distinc3}
The two motions considered are \emph{motion 4.a} and \emph{motion 4.b}.
\emph{motion 4.a} can be described by the following scenario :
...
\hline
\end{tabular}
\caption{Results of the task selection algorithm from the analysis of \emph{motion 4.a} and \emph{motion 4.b}.}
\label{tab:spotDiff3}
\vspace{-12pt}
\end{table}
...
\begin{figure}[t]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=0.4\linewidth]{img/hrp2Markers.ps} &
...
\begin{table}[t]
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{Results of the task selection algorithm from the analysis of \emph{motion 2.a} and \emph{motion 2.b} on the real robot.}
...
However, the task \emph{Head} is not kept as a candidate for any of the two motion (the residue $r$ for that task is never the lowest).
...
\begin{figure*}[hp]
  ...
  \caption{Norm of motions associated to \emph{Left grab} task (\emph{ie} motion of the left arm).
...
\begin{figure*}[p]
  ...
  \caption{Quantity of motion in the right hand space after successive projection.
...
\begin{table}[t]
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{Results of the task selection algorithm from the analysis of \emph{motion 5.a} and \emph{motion 5.b} on the real robot.}
  \label{tab:result5}
\end{table}
