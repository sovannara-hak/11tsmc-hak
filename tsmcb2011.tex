...
The set of models of possible tasks is called the \emph{task pool}.
Possible tasks may for example be end-effector, center of mass, visual or posture servoing.
The approach considered handles tasks executed in parallel. Considering 
parallel tasks allow then a good expressivity of movements thanks to the different
possible tasks combination.
The observed motion is supposed to have been generated using an unknown sub-set of those tasks.  
This is a strong assumption, but the use of the task function approach allows
a good expressivity of movements by composing a motion in a stack of tasks.
...
That last assumption discards all inequalities constraints because
