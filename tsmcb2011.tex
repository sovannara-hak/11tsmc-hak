...
\begin{figure*}[t]
  ...
  \begin{tabular}{c@{}c@{}c@{}c@{}c@{}}
    \includegraphics[height=1.9cm]{img/hak1-purpleBall1.eps}&
    \includegraphics[height=1.9cm]{img/hak2-purpleBall2.eps}&
    \includegraphics[height=1.9cm]{img/hak3-purpleBall3.eps}&
    \includegraphics[height=1.9cm]{img/hak4-purpleBall4.eps}&
    \includegraphics[height=1.9cm]{img/hak5-purpleBall5.eps}\\
  \end{tabular}
  ...
  \makebox[\linewidth]{
  \begin{tabular}{c@{}c@{}}
    \includegraphics[height=1.9cm]{img/hak6-graspFeet1.eps}&
    \includegraphics[height=1.9cm]{img/hak7-graspFeet2.eps}\\
  \end{tabular}
  ...
  \makebox[\linewidth]{
  \includegraphics[height=2.0cm]{img/hak8-spotDiff1H.eps}
  }
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{img/hak9-spotDiff.eps}
  \end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.40\linewidth]{img/hak10-final3.eps}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.40\linewidth]{img/hak11-spotDiff3.eps}
\end{center}
...
(a)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak12-Pqdot0_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak13-Pqdot0_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak14-Pqdot0_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak15-Pqdot0_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak16-Pqdot0_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak17-Pqdot0_499.png.eps}}\\

(b)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak18-Pqdot1_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak19-Pqdot1_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak20-Pqdot1_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak21-Pqdot1_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak22-Pqdot1_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak23-Pqdot1_499.png.eps}}\\

(c)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak24-Pqdot2_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak25-Pqdot2_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak26-Pqdot2_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak27-Pqdot2_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak28-Pqdot2_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak29-Pqdot2_499.png.eps}}\\

(d)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak30-Pqdot3_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak31-Pqdot3_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak32-Pqdot3_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak33-Pqdot3_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak34-Pqdot3_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak35-Pqdot3_499.png.eps}}\\

(e)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak36-Pqdot4_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak37-Pqdot4_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak38-Pqdot4_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak39-Pqdot4_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak40-Pqdot4_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak41-Pqdot4_499.png.eps}}\\

(f)&
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak42-Pqdot5_0.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak43-Pqdot5_99.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak44-Pqdot5_199.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak45-Pqdot5_299.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak46-Pqdot5_399.png.eps}} &
\parbox[c]{2.0cm}{\includegraphics[width=\linewidth]{img/hak47-Pqdot5_499.png.eps}}\\
\\
...
%\includegraphics[width=0.9\linewidth]{img/projRHNull.eps}
  \resizebox{.45\textwidth}{!} {
      \input{img/taskRhandNormInvJerr_0}
    }          &
  \resizebox{.45\textwidth}{!} {
      \input{img/taskLhandNormInvJerr_0}
    }\\
\end{tabular*}
...
\centering
  ...
  \resizebox{.46\textwidth}{!} {
      \input{img/hak51-RbeforeAfterProj.tex}
    }
  \label{fig:RbeforeAfterProj:2a}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
      \input{img/hak52-RbeforeAfterProj.tex}
  }
...
%\includegraphics[width=0.9\linewidth]{img/projRHNull.eps}
  \resizebox{.46\textwidth}{!} {
      \input{img/hak53-taskRhandNormInvJerr_0}
    }                           &
  \resizebox{.46\textwidth}{!} {
      \input{img/hak54-taskLhandNormInvJerr_0}
    }\\
\end{tabular*}
...
\begin{figure}[t]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=0.4\linewidth]{img/hak55-hrp2Markers.eps} &
    \includegraphics[height=0.4\linewidth]{img/hak56-skel.eps} \\
  \end{tabular}
...
\begin{figure*}[hp]
  ...
  \subfigure[Motion 2.a]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak57-taskHeadNormInvJerr_0.tex}
  }
  \label{fig:exp1:headFit:R}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak58-taskHeadNormInvJerr_0.tex}
  }
...
\begin{figure*}[hp]
  ...
  \subfigure[Motion 2.a]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak59-taskLhandNormInvJerr_0.tex}
  }
  \label{fig:exp1:taskLhand:R}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak60-taskLhandNormInvJerr_0.tex}
  }
...
\begin{figure*}[hp]
  ...
  \subfigure[Motion 2.a]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak61-RevolutionLH.tex}
  }
  \label{fig:exp1:Evolution2L:a}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak62-RevolutionLH.tex}
  }
...
\begin{figure*}[p]
  ...
  \subfigure[Motion 2.a]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak63-RevolutionRH.tex}
  }
  \label{fig:exp1:Evolution2R:a}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
  \input{img/hak64-RevolutionRH.tex}
  }
...
\begin{figure*}[p]
  ...
  \subfigure[Motion 2.a]{
  \resizebox{.46\textwidth}{!} {
    \input{img/hak65-PqdotNormsR}
  }
  \label{fig:exp1:PqdotNormsR}
  }
  \subfigure[Motion 2.b]{
  \resizebox{.46\textwidth}{!} {
    \input{img/hak66-PqdotNormsRL}
  }
...
\begin{figure*}[p]
  ...
  \resizebox{.46\textwidth}{!} {
    \input{img/hak67-PqdotNorms5a}
  }
  }
  \subfigure[Motion 5.b]{
  \resizebox{.46\textwidth}{!} {
    \input{img/hak68-PqdotNorms5b}
  }
}
...
\begin{figure}[t]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.4\linewidth]{img/hak69-5aFinal1.eps} &
    \includegraphics[width=0.4\linewidth]{img/hak70-5bFinal1.eps} \\
  \end{tabular}
