...
We denote $\mbf{\hat{e}}(t)$ the trajectory due to the current $\mbf{P}
...
\noindent where $\mbf{\hat{e}}(t)$ is the observed trajectory and $\mbf{e}_\mbf{x}(t)$ is the trajectory
