...
the motion data of the motion \emph{1} and the motion \emph{2}.
\begin{table}[t]
  \centering
  \begin{tabular}{|c|c|c|c|}
    \hline
...
For the \emph{right hand} motion, the projection in the task of the left hand projection has a poor fitting
