...
%This method is not adapted for reactive behavior if the robot have a lot of degrees 
...
In this work, the analyzed motion is not seen as a sequence of motion primitive but as a
...
reverse engineering based on the task function properties.
...
The control law associated to the task function approach can be decomposed in two component:
...
ambiguity produced by combination of tasks. Futhermore, the recognition method is
performed in each known task spaces.\\
...
Fig.~\ref{fig:RbeforeAfterProj} shows the right and left hand tasks errors in the \emph{motion 2.a} (before projection),
...
\end{tabular*}
\caption{Task error for the right and left hand tasks in the \emph{motion 2.a},
...
On the other hand, when projecting the \emph{motion 2.b}, the remaining motion
...
Fig.~\ref{fig:RLbeforeAfterProj} shows the right and left hand tasks errors in the \emph{motion 2.b} (before projection),
and after projection in the null space of the right hand and the \emph{Com} tasks).
\begin{figure*}[t]
\centering
\begin{tabular*}{0.9\textwidth}{@{\extracolsep{\fill}}cc}
...
Before projection & After projection\\
\end{tabular*}
\caption{Task error for the right and left hand tasks in the \emph{motion 2.b},
before and after the projection onto the null space of the \emph{right hand} task and \emph{Com} task.}
...
\vspace{-3pt}
\end{figure}
Table~\ref{tab:spotDiff2} shows the results of the tasks selection algorithm.
\begin{table}[t]
\centering
\begin{tabular}{|c|c|c|c|}
\hline
...
the motion data of the \emph{motion 2.a} and the \emph{motion 2.b}.
\begin{table}[t]
  \centering
  \begin{tabular}{|c|c|c|c|}
    \hline
...
For the \emph{motion 2.a}, the projection in the task of the left hand projection has a poor fitting
(Fig.~\ref{fig:exp1:taskLhand0:R}) with the model of the task, whereas the right hand task has a good
...
\begin{figure*}[t]
  \centering
  \subfigure[Motion 2.a - iteration 0]{
  \resizebox{.48\textwidth}{!} {
  \input{img/exp1/R/invJerror_taskCom_0}
  }
  \label{fig:exp1:taskCom0:R}
  }
  \subfigure[Motion 2.b - iteration 0]{
  \resizebox{.48\textwidth}{!} {
  \input{img/exp1/RL/invJerror_taskCom_0}
  }
  \label{fig:exp1:taskCom0:RL}
  }
  \caption{Comparison of the fitting for the center of masses regulation task for the \emph{motion 2.a} and \emph{motion 2.b} at the first iteration of the identification algorithm.
  $r$ are the residues of the optimizations.}
  \label{fig:exp1:taskCom0}
\end{figure*}

Notice that in the \emph{motion 2.b}, the candidate head task involves less motion
...
\begin{figure*}[t]
  ...
  \emph{motion 2.a} and \emph{motion 2.b} at the first
...
\begin{figure*}[t]
  \centering
  \subfigure[Motion 2.a - iteration 1]{
  \resizebox{.48\textwidth}{!} {
	\input{img/exp1/R/invJerror_taskCom_1}
    }
    \label{fig:exp1:taskCom1:R}
  }
  \subfigure[Motion 2.b - iteration 1]{
  \resizebox{.48\textwidth}{!} {
	\input{img/exp1/RL/invJerror_taskCom_1}
    }
    \label{fig:exp1:taskCom1:RL}
  }
\caption{Comparison of the fitting for the center of masses regulation task for the \emph{motion 2.a} and \emph{motion 2.b} at the second iteration of the identification algorithm.
$r$ are the residues of the optimizations.}
...
\begin{figure*}[t]
  ...
  \caption{Comparison of the fitting for the head task for the \emph{motion 2.a} and \emph{motion 2.b} at the second iteration of the identification algorithm.
$r$ are the residues of the optimizations.}
...
\begin{figure*}[t]
  ...
  \caption{Comparison of the fitting for the left hand task for the
  \emph{motion 2.a} and \emph{motion 2.b} at the second
    iteration of the identification algorithm.  $r$ are
    the residues of the optimizations.}
...
\begin{figure*}[t]
  ...
  \caption{Comparison of the fitting for the \emph{two feet} task for the \emph{motion 2.a} and \emph{motion 2.b} at the second iteration of the identification algorithm. $r$ are the residues of the optimizations.}
