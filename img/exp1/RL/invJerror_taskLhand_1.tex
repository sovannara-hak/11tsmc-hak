...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 0.944885\\ \int \Vert J^+ \dot{e}_{lhand} \Vert \mathrm{d}t &=  0.16978 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/RL/invJerror_taskLhand_1}}%
    \gplfronttext
  \end{picture}%
\endgroup
