...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 4.8668\\ \int \Vert J^+ \dot{e}_{head} \Vert \mathrm{d}t &=  0.0144548 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/RL/invJerror_taskHead_0}}%
    \gplfronttext
  \end{picture}%
\endgroup
