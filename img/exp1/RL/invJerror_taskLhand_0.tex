...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 0.943313\\ \int \Vert J^+ \dot{e}_{lhand} \Vert \mathrm{d}t &=  0.172174 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/RL/invJerror_taskLhand_0}}%
    \gplfronttext
  \end{picture}%
\endgroup
