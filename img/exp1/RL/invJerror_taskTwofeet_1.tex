...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 0.623005\\ \int \Vert J^+ \dot{e}_{twofeet} \Vert \mathrm{d}t &=  0.268388 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/RL/invJerror_taskTwofeet_1}}%
    \gplfronttext
  \end{picture}%
\endgroup
