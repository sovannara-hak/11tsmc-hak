...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 2.82285\\ \int \Vert J^+ \dot{e}_{com} \Vert \mathrm{d}t &=  0.0493135 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/R/invJerror_taskCom_0}}%
    \gplfronttext
  \end{picture}%
\endgroup
