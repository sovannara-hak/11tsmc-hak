...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 2.91967\\ \int \Vert J^+ \dot{e}_{lhand} \Vert \mathrm{d}t &=  0.177583 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/R/invJerror_taskLhand_0}}%
    \gplfronttext
  \end{picture}%
\endgroup
