...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4106,4710){\makebox(0,0){\strut{}$\begin{array}{rl} r &= 3.16366\\ \int \Vert J^+ \dot{e}_{head} \Vert \mathrm{d}t &=  0.0314432 \mathrm{rad}\\ \end{array}$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{img/exp1/R/invJerror_taskHead_1}}%
    \gplfronttext
  \end{picture}%
\endgroup
